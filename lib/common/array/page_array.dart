...
var pagesList = <PageListModel>[
  PageListModel(
      ...
      pageList: [
        ...
        PageList(
            pageName: "ForgotPassword", routeName: routeName.forgotPassword),
  ...
  PageListModel(
      ...
      pageList: [
        ...
        PageList(
            pageName: "InnerCategories", routeName: routeName.innerCategory),
  ...
  PageListModel(
      ...
      pageList: [
        ...
        PageList(
            pageName: "profileSetting", routeName: routeName.profileSetting),
  ...
  PageListModel(
      ...
      pageList: [
        PageList(
            pageName: "Terms Condition", routeName: routeName.termsCondition),
