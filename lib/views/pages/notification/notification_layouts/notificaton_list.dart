...
class NotificationList extends StatelessWidget {
  ...
  final int? index;
  const NotificationList({Key? key, this.notificationModel, this.index})
      : super(key: key);
          ...
          Container(
            decoration: BoxDecoration(
                ...
                border: Border(
                  bottom: BorderSide(
                    color: notificationModel!.isRead!
                        ? notificationCtrl.filterList[index! - 1].isRead ==
                                false
                            ? notificationCtrl.appCtrl.appTheme.whiteColor
                            : notificationCtrl.appCtrl.appTheme.whiteColor
                  ...
                  child: Column(
                    ...
                    children: [
                      LatoFontStyle(
                        ...
                        color: notificationCtrl.appCtrl.appTheme.blackColor,
                      ...
                      LatoFontStyle(
                        ...
                        color: notificationCtrl.appCtrl.appTheme.contentColor,
