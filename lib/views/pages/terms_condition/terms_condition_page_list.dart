export 'package:multikart/views/pages/terms_condition/terms_condition_layouts/terms_condition_description.dart';
export 'package:multikart/views/pages/terms_condition/terms_condition_utils/terms_condition_widget.dart';
