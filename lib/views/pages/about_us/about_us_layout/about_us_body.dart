        ...
        children: [
          ...
          Column(
            ...
            children: [
              ...
              //title text layout
              AboutUsWidget().commonText(
                  aboutUsCtrl.aboutUsModel!.title.toString().tr,
                  FontWeight.w600,
                  FontSizes.f14),
              const Space(0, 20),
              ...
              AboutUsWidget().commonDescText(
                  aboutUsCtrl.aboutUsModel!.desc1.toString().tr),
              const Space(0, 20),

              //description2 text layout
              AboutUsWidget().commonDescText(
                  aboutUsCtrl.aboutUsModel!.desc2.toString().tr),
              const Space(0, 30),
              ...
              AboutUsWidget().commonDescText(
                  aboutUsCtrl.aboutUsModel!.desc3.toString().tr),
              const Space(0, 20),
              AboutUsWidget().commonText(
                  AboutUSFont().ourBrandTitle, FontWeight.w700, FontSizes.f16),
              const Space(0, 20),

              //our brand text layout
              AboutUsWidget().commonDescText(
                  aboutUsCtrl.aboutUsModel!.ourBrand.toString().tr),
              const Space(0, 20),
            ],
