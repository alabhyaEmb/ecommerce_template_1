        ...
        children: [
          Column(
            ...
            children: [
              ...
              const Space(0, 5),
              LatoFontStyle(
                  text: profileModel!.subTitle,
                  fontSize: FontSizes.f12,
                  color: appCtrl.appTheme.contentColor)
            ],
          ),
          if (profileModel!.title == "Mode" ||
              profileModel!.title == "الوضع" ||
              profileModel!.title == "तरीका" ||
              profileModel!.title == "방법")
            ThemeSwitcher(
                onToggle: (val) {
                  appCtrl.isTheme = val;
                  appCtrl.update();
          ...
          if (profileModel!.title == "Notification" ||
              profileModel!.title == "공고" ||
              profileModel!.title == "अधिसूचना" ||
              profileModel!.title == "تنبيه")
            ThemeSwitcher(
                onToggle: (val) {
